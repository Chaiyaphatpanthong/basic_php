...
<form name="form1" action="insert.php" method="POST">
    ...
    <div class="col-md-2">
        ...
        <input type="radio" class="form-check-input" name="text_sex" id="text_sex" value="ชาย">ชาย<br>
        <input type="radio" class="form-check-input" name="text_sex" id="text_sex" value="หญิง">หญิง<br>
    </div>
...
<div class="container text-center">
  <br>
    <center>
      <button type="submit" class="btn btn-success text-light">บันทึก</button>
      <button type="reset" class="btn btn-danger text-light">ยกเลิก</button>
    </center>
</div>
</div>
</form>
